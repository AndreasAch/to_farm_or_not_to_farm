...
class FarmApp(QWidget):
    def __init__(self):
        ...
        self.event_text_dict = {
            'Normal': '<html><head/><body><p align="center"><img src="../assets/normal_weather.png"/><span style=" font-weight:600;"> Normal weather conditions </span><img src="../assets/normal_weather.png"/></p><p><span style=" font-size:18pt; color:#000000;">All crops grow naturally, normal water consumption and growth progression for all crops.</span></p><p><img src="../assets/wheat.png"/><span style=" font-size:18pt;"> Wheat: +4 stages (</span><img src="../assets/water.png"/><span style=" font-size:18pt;">)<br/></span><img src="../assets/carrot.png"/><span style=" font-size:18pt;"> Carrot: +3 stages (</span><img src="../assets/water.png"/><img src="../assets/water.png"/><span style=" font-size:pt;">) <br/></span><img src="../assets/tomato.png"/><span style=" font-size:pt;"> Tomato: +2 stages (</span><img src="../assets/water.png"/><img src="../assets/water.png"/><img src="../assets/water.png"/><span style=" font-size:pt;">) </span></p></body></html>',
            'Drought': '<html><head/><body><p align="center"><img src="../assets/drought.png"/><span style=" font-weight:600;"> Drought </span><img src="../assets/drought.png"/></p><p><span style=" font-size:pt;">Water shortage, your plants grow slow, </span><span style=" font-size:pt; font-weight:600; color:#aa0000;">only +1 stage for all crops</span><span style=" font-size:pt;">. You may pay the cost (</span><img src="../assets/coins.png"/><span style=" font-size:pt;">) of irrigation to mitigate the effects</span></p><p><img src="../assets/wheat.png"/><span style=" font-size:pt;"> Wheat: +4 stages (</span><img src="../assets/water.png"/>, <img src="../assets/coins.png"/><span style=" font-size:pt;">) <br/></span><img src="../assets/carrot.png"/><span style=" font-size:pt;"> Carrot: +3 stages (</span><img src="../assets/water.png"/><img src="../assets/water.png"/>, <img src="../assets/coins.png"/><img src="../assets/coins.png"/><span style=" font-size:pt;">) <br/></span><img src="../assets/tomato.png"/><span style=" font-size:pt;"> Tomato: +2 stages (</span><img src="../assets/water.png"/><img src="../assets/water.png"/><img src="../assets/water.png"/>, <img src="../assets/coins.png"/><img src="../assets/coins.png"/><span style=" font-size:pt;">) </span></p></body></html>',
            ...
            'Hail': '<html><head/><body><p align="center"><img src="../assets/hail.png"/><span style=" font-weight:600;"> Hail </span><img src="../assets/hail.png"/></p><p><span style=" font-size:pt; color:#000000;">Hail is causing the crops to get damaged. The crop\'s growth is determined by it\'s current state, they may only move 1 stage forwards or backwards:</span></p><p><img src="../assets/wheat.png"/><img src="../assets/carrot.png"/><img src="../assets/tomato.png"/><span style=" font-size:pt;"/><span style=" font-size:pt; color:#aa0000;"> All crops stages 1-3:</span><span style=" font-size:pt;"> -1 stage backwards (</span><img src="../assets/water.png"/><span style=" font-size:pt;">)<br/></span><img src="../assets/wheat.png"/><img src="../assets/carrot.png"/><img src="../assets/tomato.png"/><span style=" font-size:pt; color:#aa0000;"> All crops stages 4-5:</span><span style=" font-size:pt;"> +1 stage forwards (</span><img src="../assets/water.png"/><span style=" font-size:pt;">)</span></p></body></html>'
        }
