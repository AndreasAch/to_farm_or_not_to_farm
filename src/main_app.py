...
class FarmApp(QWidget):
    def __init__(self):
        ...
        with open('../assets/normal_rich_text', 'r') as f:
            normal = f.read()
        with open('../assets/drought_rich_text', 'r') as f:
            drought = f.read()
        with open('../assets/rain_rich_text', 'r') as f:
            rain = f.read()
        with open('../assets/hail_rich_text', 'r') as f:
            hail = f.read()
